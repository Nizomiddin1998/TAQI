                    ...
                    <div className='haqida_father'>
                        <div className='haqida_left'>
                            <div className='umumiy'>
                                <p><b>Umumiy</b> </p>
                                <p><Link to="about">Institut tarixi</Link> </p>
                                <p>  <Link to="/mamuriyat" >Universitet ma'muriyati</Link>  </p>
                                <p> <Link to="/tashkilot"> Tashkilot jadvali </Link> </p>
                                <p> <Link to="/umumiy">  Umumiy ma'lumotlar  </Link>  </p>
                                <p> <Link to="/sifat">  Sifatni taminlash tizimi </Link>  </p>
                                <p> <Link to="/senat">  Universitet senati qarorlari  </Link>  </p>
                                <p> <Link to="/boshqaruv">  Universitet boshqaruvi  </Link>  </p>
                            ...
                            <div className='Mamuriy'>
                                ...
                                <p><a href="#">Bo'limlar / Bo'linmalar</a></p>
                                <p><a href="#">Direktoriyalar</a></p>
                                <p><a href="#">Muvofiqlashtirish Birliklari</a></p>
                                <p><a href="#">Ofislar   </a></p>
                                <p><a href="#">Axborot birligi huquqi</a></p>
                                <p><a href="#">Boshqa birliklar </a></p>
                                <p> </p>
                            </div>
                            <div className='Mamuriy'>
                                <p><b>TAQIga bir nazar </b></p>
                                <p><a href="#">Xotira Daraxti</a></p>
                                <p><a href="#">TAQI bosqichi</a></p>
                                <p><a href="#">TAQI tasvirlar bilan</a></p>
                                <p><a href="#">Umumiy ma'lumotlar    </a></p>
                                <p><a href="#">TAQicam</a></p>
                                <p><a href="#">TAQI bir qarashda(image)</a></p>
